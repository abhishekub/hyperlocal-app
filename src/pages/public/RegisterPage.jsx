    ...
    <div className="tr-auth-root">
      ...
      <div className="tr-auth-stage">
        ...
        <div className="tr-stage-body">
          <div className="tr-mesh-badge">Hyperlocal Protocol</div>
          <h1 className="tr-stage-title">
            One network, <span>zero travel markup.</span>
          </h1>
          <p className="tr-stage-desc">
            Connect instantly with nearby customers or offer your expertise locally with browser-calculated dispatch routing.
          </p>
        ...
        <div className="tr-stage-footer">
          Client-Side Spatial Verification Protocol
        </div>
      </div>
      ...
      <div className="tr-form-canvas">
        <div className="tr-auth-card">
          <div className="tr-card-header">
            <h2 className="tr-card-title">Create Account</h2>
            <p className="tr-card-subtitle">Choose your account type to get started</p>
          </div>
          ...
          <p className="tr-card-footer">
            ...
            <Link to="/login" className="tr-link">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
